...
const ConfigSchema = z.object({
  ...
  security: z.object({
    ...
    allowedFileTypes: z.array(z.string()).default(['.jpg', '.jpeg', '.png', '.pdf']),
  ...
  private loadEnvironmentVariables(): any {
    ...
    return {
      server: {
        ...
        sessionSecret: env.SESSION_SECRET || this.generateSecretWarning('SESSION_SECRET'),
      ...
      openai: {
        apiKey: env.OPENAI_API_KEY || this.throwMissingEnvError('OPENAI_API_KEY'),
      ...
      features: {
        ...
        conversationLoggingEnabled: env.CONVERSATION_LOGGING_ENABLED !== 'false',
