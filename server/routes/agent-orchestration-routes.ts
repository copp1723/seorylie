  ...
  asyncHandler(async (req: Request, res: Response) => {
    try {
      ...
      return ResponseHelper.success(
        res,
        status,
        "Workflow execution status retrieved",
      );
    } catch (error) {
  ...
  asyncHandler(async (req: Request, res: Response) => {
    try {
      ...
      return ResponseHelper.success(
        res,
        result,
        "Analytics service call successful",
      );
    } catch (error) {
...
router.post(
  ...
  asyncHandler(async (req: Request, res: Response) => {
    ...
    try {
      ...
      const result = await agentOrchestrator.callAutomationService(
        operation,
        parameters,
      );
      ...
      return ResponseHelper.success(
        res,
        result,
        "Automation service call successful",
      );
    } catch (error) {
...
router.post(
  ...
  [
    ...
    body("steps")
      .isArray()
      .notEmpty()
      .withMessage("Workflow steps are required"),
    body("supportedAgentTypes")
      .isArray()
      .notEmpty()
      .withMessage("Supported agent types are required"),
  ...
  asyncHandler(async (req: Request, res: Response) => {
    ...
    try {
      ...
      logger.info(
        `Custom workflow registered: ${workflowDefinition.name} (${workflowDefinition.id})`,
        {
...
router.get(
  ...
  asyncHandler(async (req: Request, res: Response) => {
    try {
      ...
      try {
        const analyticsHealth = await agentOrchestrator.callAnalyticsService({
          operation: "health",
        });
      ...
      try {
        const automationHealth = await agentOrchestrator.callAutomationService(
          "health",
          {},
        );
