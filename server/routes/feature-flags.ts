...
import { featureFlags, FeatureFlag, FeatureFlagConfig } from '../services/feature-flags.js';
...
const createFlagSchema = z.object({
  name: z.string().min(1).regex(/^[a-z0-9-]+$/, 'Flag name must contain only lowercase letters, numbers, and hyphens'),
