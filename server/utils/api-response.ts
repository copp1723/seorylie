...
> = {
  ...
  [ERROR_CODES.INVENTORY_IMPORT_FAILED]: {
    userMessage:
      "Failed to import inventory. Please check your file format and try again.",
  ...
  [ERROR_CODES.DEALERSHIP_INACTIVE]: {
    userMessage:
      "This dealership is currently inactive. Please contact support.",
...
export function sendValidationError(
  ...
  const response: ErrorResponse = {
    ...
    error: message,
    userMessage:
      ERROR_CONFIGS[ERROR_CODES.VALIDATION_ERROR]?.userMessage ||
...
export function sendUnauthorized(res: Response, message?: string): void {
  sendError(res, ERROR_CODES.UNAUTHORIZED, HttpStatus.UNAUTHORIZED, undefined, {
    userMessage:
      message ||
      ERROR_CONFIGS[ERROR_CODES.UNAUTHORIZED]?.userMessage ||
...
export function sendForbidden(res: Response, message?: string): void {
  sendError(res, ERROR_CODES.FORBIDDEN, HttpStatus.FORBIDDEN, undefined, {
    userMessage:
      message ||
      ERROR_CONFIGS[ERROR_CODES.FORBIDDEN]?.userMessage ||
      "Access denied",
  });
}
