...
export async function calculateLeadScore(
  ...
  const customerMessages = messageHistory.filter(
  ...
  factors.urgencySignals =
    countKeywordMatches(customerMessages, urgencyKeywords) * 5;
  ...
  const longMessages = customerMessages.filter(
  ...
  factors.buyerSignals =
    countKeywordMatches(customerMessages, buyerKeywords) * 4;
