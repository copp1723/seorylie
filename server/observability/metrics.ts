...
export function recordToolExecution(
  ...
  toolExecutionDuration
    .labels(toolName, sandboxIdStr, status)
...
export function recordAgentExecution(
  ...
  agentExecutionDuration
    .labels(agentType, sandboxIdStr, status)
    .observe(durationSeconds);
}
...
export function recordOpenAIRequest(
  ...
  openaiRequestDuration
    .labels(operationType, model, status)
    .observe(durationSeconds);
...
export function recordTokenUsage(
  ...
  tokenUsageCounter
    .labels(sandboxIdStr, operationType, sessionIdStr)
    .inc(tokensUsed);
  ...
  openaiCostCounter
    .labels(sandboxIdStr, "gpt-4", operationType)
    .inc(estimatedCost);
}
...
export function recordRateLimit(
  ...
  errorCounter
    .labels(sandboxIdStr, "rate_limit_exceeded", "orchestrator")
    .inc();
}
...
export function recordDuration(
  ...
  const sandboxIdStr = dealershipId ? String(dealershipId) : "unknown";
  toolExecutionDuration
    .labels(metric, sandboxIdStr, "success")
    .observe(durationSeconds);
}
