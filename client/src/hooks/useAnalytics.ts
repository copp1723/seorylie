...
export const useAnalytics = (): AnalyticsHook => {
  ...
  const trackPageViewFn = useCallback(
    (pageName: string, parameters: EventParameters = {}) => {
      if (isEnabled) {
  ...
  const trackFeatureUsage = useCallback(
    (featureName: string, parameters: EventParameters = {}) => {
  ...
  const trackConversion = useCallback(
    (conversionType: string, parameters: EventParameters = {}) => {
