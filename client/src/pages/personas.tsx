...
const personaSchema = z.object({
  ...
  promptTemplate: z
    .string()
    .min(50, "Prompt template must be at least 50 characters"),
  arguments: z
    .object({
...
export default function Personas() {
  ...
  // Fetch personas for the current dealership - TEMPORARILY DISABLED
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        {personas.length === 0 ? (
          ...
          personas.map((persona: PersonaFormValues) => (
            <Card
              key={persona.id}
              className={persona.isDefault ? "border-primary" : ""}
            >
              <CardHeader>
              ...
              <CardContent>
                <div className="space-y-2">
                  <div className="text-sm">
                    ...
                    {persona.arguments?.tone || "Not specified"}
                  </div>
                  {persona.arguments?.priorityFeatures &&
                    persona.arguments.priorityFeatures.length > 0 && (
                      <div className="text-sm">
                        <span className="font-medium">Priority Features:</span>
                        <div className="flex flex-wrap gap-1 mt-1">
                          {persona.arguments.priorityFeatures.map(
                            (feature, i) => (
                              <span
                                key={i}
              ...
              <CardFooter className="flex justify-between">
                ...
                <Button
                  variant="destructive"
                  onClick={() =>
                    persona.id && deletePersonaMutation.mutate(persona.id)
                  }
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            placeholder="Friendly Sales Assistant"
                            {...field}
                          />
                        </FormControl>
                        <FormDescription>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          The system prompt that defines how Rylie behaves for
                          this persona. Use variables like{" "}
                          {"{{dealershipName}}"} that will be replaced at
                          runtime.
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          Vehicle features that should be emphasized in
                          conversations
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            placeholder="https://example.com/trade-in"
                            {...field}
                          />
                        </FormControl>
                        <FormDescription>
                          URL for customers interested in trading in their
                          vehicle
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            placeholder="https://example.com/financing"
                            {...field}
                          />
                        </FormControl>
                        <FormDescription>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          Email address where lead handover dossiers will be
                          sent
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
