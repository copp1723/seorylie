...
export default function SetupPage() {
  return (
    <div className="container mx-auto py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-semibold text-gray-900 mb-2">System Setup</h1>
        <p className="text-gray-600">Configure system settings, integrations, and customize your experience</p>
      </div>
            ...
            <CardContent className="space-y-4">
              <div className="grid gap-4">
                <div className="grid grid-cols-2 items-center gap-4">
                  ...
                  <Input id="app-name" defaultValue="Automotive Sales AI Platform" />
                </div>
                ...
                <div className="grid grid-cols-2 items-center gap-4">
                  <div className="flex flex-col space-y-1">
                    ...
                    <span className="text-sm text-gray-500">Enable dark mode by default</span>
                  </div>
                ...
                <div className="grid grid-cols-2 items-center gap-4">
                  <div className="flex flex-col space-y-1">
                    ...
                    <span className="text-sm text-gray-500">Enable email notifications</span>
                  </div>
                  <div className="flex items-center space-x-2">
              ...
              <div className="grid gap-4">
                ...
                <div className="grid grid-cols-2 items-center gap-4">
                  <div className="flex flex-col space-y-1">
                    ...
                    <span className="text-sm text-gray-500">Use compact density for tables and lists</span>
                  </div>
                  <div className="flex items-center space-x-2">
              ...
              <div className="grid gap-4">
                <div className="grid grid-cols-2 items-center gap-4">
                  <div className="flex flex-col space-y-1">
                    ...
                    <span className="text-sm text-gray-500">Connect to OpenAI API for AI capabilities</span>
                  </div>
                  <div className="flex items-center space-x-2">
                ...
                <div className="grid grid-cols-2 items-center gap-4">
                  <div className="flex flex-col space-y-1">
                    ...
                    <span className="text-sm text-gray-500">Connect to your CRM system</span>
                  </div>
                  <div className="flex items-center space-x-2">
                ...
                <div className="grid grid-cols-2 items-center gap-4">
                  ...
                  <Input id="crm-endpoint" placeholder="https://your-crm.example.com/api" />
                </div>
              </div>
              ...
              <div className="grid gap-4">
                ...
                <div className="grid grid-cols-2 items-center gap-4">
                  <div className="flex flex-col space-y-1">
                    ...
                    <span className="text-sm text-gray-500">Automatically archive old data</span>
                  </div>
                  <div className="flex items-center space-x-2">
              ...
              <div className="grid gap-4">
                ...
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Run optimization to improve performance</p>
                  </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="grid gap-6">
                <div>
                  <h3 className="text-sm font-medium mb-2">Import Vehicle Inventory</h3>
                ...
                <div>
                  <h3 className="text-sm font-medium mb-2">Export System Data</h3>
