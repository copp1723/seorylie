...
export default function DealershipSetup() {
  ...
  const [specificInstructions, setSpecificInstructions] = useState("Always start with a casual, personal greeting like 'Hey [Name], thanks for reaching out!' or 'Hi [Name], glad you messaged!'—never use stiff openers like 'Dear' or 'At [Dealership], we strive to…'.\n\nUse contractions (e.g., 'I don't' instead of 'I do not'), everyday words, and phrases you'd hear in a real conversation.\n\nAvoid corporate or scripted language—no 'strive to accommodate,' 'assist you further,' 'valued customer,' or similar formalities.");
...

{
  ...
  return (
    <>
      ...
      <Tabs defaultValue="dealership" onValueChange={setActiveTab} className="w-full">
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="location" placeholder="e.g. 123 Main St, City, State" />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  This description will be used by the AI to understand your dealership's brand and values.
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input id="website" placeholder="e.g. https://www.abcmotors.com" />
              </div>
              
              <div className="space-y-2">
                <Label htmlFor="specialties">Dealership Specialties</Label>
                <Input id="specialties" placeholder="e.g. Luxury Cars, SUVs, Electric Vehicles" />
                <p className="text-sm text-muted-foreground">
                  Enter the types of vehicles or services your dealership specializes in, separated by commas.
                </p>
              </div>
            </CardContent>
              ...
              <div className="space-y-4">
                    ...
                    <Card className="border-2 border-primary cursor-pointer">
                      <CardHeader className="py-3 px-4">
                        <CardTitle className="text-base flex items-center">
                          <span className="material-icons mr-2 text-primary">verified</span>
                          CSV/TSV Upload
                        </CardTitle>
                      </CardHeader>
                    </Card>
                ...
                <div className="space-y-2">
                  ...
                  <div className="mt-2 flex items-center justify-center rounded-lg border border-dashed p-6 cursor-pointer hover:border-primary">
                    <div className="text-center">
                      <span className="material-icons text-muted-foreground text-3xl mb-2">upload_file</span>
                      <p className="text-sm font-medium">
                        Drag and drop your inventory file, or <span className="text-primary">browse</span>
                      </p>
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    <Button variant="outline" className="justify-start">Hourly</Button>
                    <Button variant="default" className="justify-start">Daily</Button>
                    <Button variant="outline" className="justify-start">Weekly</Button>
                  </div>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-sm text-muted-foreground">
                    This is the name that customers will see when interacting with your AI assistant.
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                    ...
                    <Button variant="default" className="justify-start">Friendly</Button>
                    <Button variant="outline" className="justify-start">Casual</Button>
                    <Button variant="outline" className="justify-start">Formal</Button>
                    <Button variant="outline" className="justify-start">Enthusiastic</Button>
                    <Button variant="outline" className="justify-start">Luxury</Button>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-sm text-muted-foreground">
                    These specific instructions will guide how the AI communicates with customers.
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-sm text-muted-foreground">
                    These constraints define limits on what the AI can discuss or promise.
                  </p>
                </div>

                <div className="space-y-4">
                  <h3 className="text-md font-medium">Dealership Resource URLs</h3>
                  <p className="text-sm text-muted-foreground">
                    These URLs will be used when customers ask about specific services.
                  </p>
                  ...
                  <div className="space-y-2">
                    ...
                    />
                    <p className="text-sm text-muted-foreground">
                      This link will be provided when customers ask about financing options.
                    </p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    />
                    <p className="text-sm text-muted-foreground">
                      This link will be provided when customers ask about trading in their current vehicle.
                    </p>
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="appointmentUrl">Appointment Scheduling URL</Label>
                    <Input 
                      id="appointmentUrl" 
                    ...
                    />
                    <p className="text-sm text-muted-foreground">
                      This link will be provided when customers want to schedule a test drive or service appointment.
                    </p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    />
                    <p className="text-sm text-muted-foreground">
                      This link will be provided when customers want to browse the full vehicle inventory.
                    </p>
                  </div>
                </div>
                  ...
                  <div className="space-y-3 mt-2">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Automatically hand over to a human agent when certain triggers are detected
                        </p>
                      </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="font-medium">Collect Customer Information</p>
                        <p className="text-sm text-muted-foreground">
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Create a summary of the conversation for the human agent
                        </p>
                      </div>
            ...
            <CardFooter className="flex justify-between">
              ...
              <Dialog open={showPreview} onOpenChange={setShowPreview}>
                <DialogTrigger asChild>
                  <Button variant="outline" className="mr-2">Preview System Prompt</Button>
                </DialogTrigger>
                <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
                  <DialogHeader>
                    <DialogTitle>System Prompt Preview</DialogTitle>
                    <DialogDescription>
                      This is how the system prompt will look with your current customizations.
                    </DialogDescription>
                  </DialogHeader>
                  <div className="bg-muted p-4 rounded-md">
                    <pre className="whitespace-pre-wrap text-sm">{generateSystemPrompt()}</pre>
                  </div>
                  <DialogFooter>
