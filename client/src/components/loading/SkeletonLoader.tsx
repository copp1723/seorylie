...
export const SkeletonLoader: React.FC<SkeletonBaseProps> = ({
  ...
  const defaultBgColor =
    theme.colors.skeleton || theme.colors.border || "#e0e0e0";
...
export const SkeletonCard: React.FC<SkeletonCardProps> = ({
  ...
  const cardStyle: CSSProperties = {
    ...
    gap: "12px",
    backgroundColor:
      theme.colors.cardBackground || theme.colors.background || "#fff",
  };
  ...
  return (
    ...
    >
            ...
            .map((_, i) => (
              <div
                ...
                style={{
                  ...
                  padding: "16px",
                  boxShadow:
                    theme.shadows?.card || "0 2px 8px rgba(0, 0, 0, 0.1)",
                  display: "flex",
                  flexDirection: "column",
                  gap: "8px",
                }}
      ...
      {showCharts && (
        ...
        >
          {Array(isSmallScreen ? 2 : isMediumScreen ? 4 : cards)
            .fill(0)
            .map((_, i) => (
              <div
                key={`chart-${i}`}
...
export const SkeletonConversation: React.FC<SkeletonConversationProps> = ({
  ...
  return (
    ...
    >
      <div
        className="skeleton-conversation-messages"
        style={{
          flex: 1,
          display: "flex",
          flexDirection: "column",
                ...
                <div style={{ height: chartHeight, position: "relative" }}>
                  ...
                  {chartType === "line" && (
                    ...
                    >
                            ...
                            .map((_, j) => (
                              <div
                                ...
                                style={{
                                  borderBottom:
                                    j < 4
                                      ? `1px dashed ${theme.colors.border || "#e0e0e0"}`
                                      : "none",
                                  flex: 1,
                                }}
                              />
                      ...
                      <svg
                        width="100%"
                        height={showAxis ? "calc(100% - 24px)" : "100%"}
                        viewBox="0 0 100 50"
