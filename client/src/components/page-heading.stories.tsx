...
const meta: Meta<typeof PageHeading> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "A reusable page heading component with title, description, and action slots.",
      },
    },
  },
  argTypes: {
...
export const WithDescription: Story = {
  args: {
    ...
    description:
      "Manage your dealership's vehicle inventory, pricing, and availability. Track sales performance and optimize your stock levels.",
  },
};
...
export const WithMultipleActions: Story = {
  args: {
    ...
    description:
      "Comprehensive analytics and reporting for your dealership performance",
    children: (
      <div className="flex gap-2">
...
export const LongTitle: Story = {
  args: {
    ...
    description:
      "Comprehensive tools for managing customer relationships, tracking leads through the sales funnel, and optimizing your dealership's customer acquisition process.",
  },
};
