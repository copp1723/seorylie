...
const errorRateLimitCache = new Map<
  string,
...
Timestamp: ${new Date().toISOString()}
  ...
  return (
    <Toast
      variant={variant}
      className={cn("group flex flex-col", expanded && "min-h-[150px]")}
      aria-live={ariaLive}
    >
      ...
      {showCloseButton && (
        <ToastClose onClick={onDismiss} aria-label="Close error notification" />
      )}
    </Toast>
  );
};
  ...
  const showErrorToast = useCallback(
    (props: Omit<ActionableToastProps, "variant"> & { id?: string }) => {
      ...
      return toast({
        ...
        action: <ActionableToast {...restProps} variant="destructive" />,
      });
    },
    [toast],
  );
  ...
  const showWarningToast = useCallback(
    (props: Omit<ActionableToastProps, "variant"> & { id?: string }) => {
      ...
      return toast({
        ...
        title: props.title,
        description: props.description,
        action: <ActionableToast {...restProps} variant="warning" />,
      });
    },
    [toast],
  );
  ...
  const showInfoToast = useCallback(
    (props: Omit<ActionableToastProps, "variant"> & { id?: string }) => {
      ...
      return toast({
        ...
        title: props.title,
        description: props.description,
        action: <ActionableToast {...restProps} variant="info" />,
      });
    },
    [toast],
  );
  ...
  const showSuccessToast = useCallback(
    (props: Omit<ActionableToastProps, "variant"> & { id?: string }) => {
      ...
      return toast({
        ...
        title: props.title,
        description: props.description,
        action: <ActionableToast {...restProps} variant="success" />,
      });
    },
    [toast],
  );
