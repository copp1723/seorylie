...
} from "../../server/services/prompt-template-service";
...
describe("Prompt Template System", () => {
  ...
  describe("Template Selection", () => {
    ...
    it("should prefer exact lead source matches", async () => {
      ...
      if (template) {
        ...
        expect(
          template.leadSource === "facebook" || template.leadSource === null,
        ).toBe(true);
      }
    });
  ...
  describe("Template Variable Validation", () => {
    ...
    it("should validate variable types", () => {
      const mockTemplate: PromptTemplate = {
        ...
        templateType: "qualification",
        promptContent:
          "Your budget is {{budget}} and year preference is {{year}}",
        tone: "professional",
        language: "en",
        variables: [
          {
  ...
  describe("Template Rendering", () => {
    it("should render templates with variables correctly", () => {
      const template =
        "Hello {{customerName}}, welcome to {{dealershipName}}! We have a great {{vehicleMake}} {{vehicleModel}} for you.";
      ...
      expect(rendered).toBe(
        "Hello John, welcome to Premium Motors! We have a great Honda Accord for you.",
      );
    ...
    it("should handle missing variables gracefully", () => {
      const template =
        "Hello {{customerName}}, your {{missingVariable}} is ready!";
    ...
    it("should handle custom variables", () => {
      const template =
        "Your budget of {{budget}} qualifies you for {{financing_option}}";
      ...
      expect(rendered).toBe(
        "Your budget of $25,000 qualifies you for premium financing",
      );
    });

    it("should handle special characters and formatting", () => {
      const template =
        "Hi {{customerName}}! Your payment would be ~${{payment}}/month 🚗";
  ...
  describe("Template Management", () => {
    it("should create new templates with validation", async () => {
      const newTemplate = {
        ...
        promptContent:
          "Hi {{customerName}}, following up on your interest in {{vehicleMake}}",
  ...
  describe("Error Handling and Edge Cases", () => {
    ...
    it("should handle very large templates", () => {
      const largeTemplate =
        "Hello {{customerName}}! " +
        "This is a very long template. ".repeat(1000);
    ...
    it("should handle templates with no variables", () => {
      const staticTemplate =
        "Welcome to our dealership! We have great deals today.";
    ...
    it("should validate template content for security", () => {
      const maliciousTemplate =
        'Hello {{customerName}}, your data: <script>alert("xss")</script>';

      const validation =
        templateService.validateTemplateContent(maliciousTemplate);
