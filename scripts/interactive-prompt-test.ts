 ...
 */
async function processChatMessage(customerMessage: string, customerName: string = 'Customer') {
...
async function runInteractiveTest() {
  ...
  console.log('Type your message as if you were a customer contacting the dealership.');
  ...
  rl.question('Enter a customer name for the test (or press Enter for default): ', (name) => {
    if (name && name.trim() !== '') {
