...
async function testRylie() {
  try {
    ...
    const initialMessage =
      "Hi there, I'm looking for a family SUV with good safety features. Can you help me?";
    ...
    const followUpMessage =
      "I'm particularly interested in the Toyota RAV4. Does it have all-wheel drive?";
    ...
    const escalationMessage =
      "What's the best financing deal you can offer me on this RAV4?";
    ...
    if (escalationData.status === "escalated") {
      console.log(
        "✅ Successfully detected financing question and escalated to human support.",
      );
    }
