...
requiredEnvVars.forEach(varName => {
  ...
  const status = value ? '✅' : '❌';
  const display = value ? (varName === 'SESSION_SECRET' || varName === 'DATABASE_URL' ? '[HIDDEN]' : value) : 'NOT SET';
...
console.log('  Check static: curl -I https://your-domain.com/assets/index-*.js');
