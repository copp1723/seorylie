...
async function testHandoverDossier() {
  try {
    ...
    const initialMessage =
      "Hi there, I'm interested in a luxury SUV for my family. We need something with three rows of seats.";
    ...
    const followupMessage =
      "I currently have a BMW X5, but I'm looking to upgrade. Do you have any X7s in stock?";
    ...
    const handoverMessage =
      "I'm ready to buy today if you can give me your best price. I can come in this afternoon to finalize the deal.";
    ...
    if (handoverData.status === "escalated") {
      ...
      console.log(
        `✅ Escalation reason: ${handoverData.escalationReason || "Not specified"}`,
      );
      ...
      console.log(
        `Conversation status in database: ${conversationData.conversation.status}`,
      );
      console.log(
        `✅ Status correctly set to '${conversationData.conversation.status}'`,
      );
