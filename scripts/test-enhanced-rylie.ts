...
async function testEnhancedRylie() {
  try {
    ...
    const updatePersonaResponse = await fetch(
    ...
    const initialMessage =
      "Hey there! I've been looking at SUVs for my growing family. We need something spacious but also good on gas.";
    ...
    const tradeInMessage =
      "I have a 2018 Honda Civic I'd like to trade in. How does that process work?";
    ...
    const financingMessage =
      "What kind of financing options do you offer for qualified buyers?";
    ...
    const handoverMessage =
      "I'm ready to buy! Can I come in today to sign the papers and drive home in my new SUV?";
    ...
    if (handoverData.status === "escalated") {
      ...
      console.log(
        `✅ Handover reason: ${handoverData.handoverReason || "Not specified"}`,
      );
      console.log(
        `✅ A handover dossier email would have been sent to: sales@example.com`,
      );
    }
