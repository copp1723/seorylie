...
console.log(
  chalk.yellow("This script has been replaced by validate-environment.ts"),
);
console.log(
  chalk.yellow("Please use: npx tsx scripts/validate-environment.ts\n"),
);
...
validator
  ...
  .then(() => {
    ...
    console.log(
      "• Update your scripts to use: npx tsx scripts/validate-environment.ts",
    );
