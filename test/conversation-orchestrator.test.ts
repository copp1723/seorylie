...
describe("ConversationOrchestrator", () => {
  ...
  describe("Lead Processing", () => {
    ...
    it("should calculate lead priority correctly", async () => {
      ...
      const priority = (orchestrator as any).calculatePriority(
        highPriorityLead,
      );
  ...
  describe("Conversation Turn Processing", () => {
    ...
    it("should determine next action correctly for two-turn mode", async () => {
      ...
      let nextAction = (orchestrator as any).determineNextAction(
        context,
        response,
        1,
      );
      ...
      nextAction = (orchestrator as any).determineNextAction(
        context,
        response,
        2,
      );
    ...
    it("should escalate on explicit escalation signal", async () => {
      ...
      const nextAction = (orchestrator as any).determineNextAction(
        context,
        response,
        1,
      );
  ...
  describe("Health Monitoring", () => {
    ...
    it("should determine health status correctly", async () => {
      ...
      const status = (orchestrator as any).determineOverallHealth(
        queueCounts,
        circuitBreakerStats,
      );
  ...
  describe("Error Handling and Resilience", () => {
    ...
    it("should handle database connection failures gracefully", async () => {
      mockDb.default.execute.mockRejectedValue(
