...
import { EnvironmentValidator, type ValidationOptions } from '../../tools/validation/validate-environment';
...
describe('EnvironmentValidator', () => {
  ...
  describe('Required Variables Validation', () => {
    it('should pass when all required variables are valid', async () => {
      ...
      process.env.SESSION_SECRET = 'very-long-secure-session-secret-with-enough-entropy-12345';
      process.env.OPENAI_API_KEY = 'sk-1234567890abcdef1234567890abcdef1234567890abcdef';
      process.env.SENDGRID_API_KEY = 'SG.1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef';
  ...
  describe('Production Environment Validation', () => {
    ...
    it('should pass when all production variables are set', async () => {
      process.env.DATABASE_URL = 'postgresql://user:pass@localhost:5432/testdb';
      process.env.SESSION_SECRET = 'very-long-secure-session-secret-with-enough-entropy-for-production-use-12345';
      process.env.OPENAI_API_KEY = 'sk-1234567890abcdef1234567890abcdef1234567890abcdef';
      process.env.SENDGRID_API_KEY = 'SG.1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef';
      process.env.REDIS_URL = 'redis://localhost:6379';
      process.env.CREDENTIALS_ENCRYPTION_KEY = 'very-long-encryption-key-for-production-use-with-sufficient-entropy-12345';
      process.env.NODE_ENV = 'production';
