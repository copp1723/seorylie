...
vi.mock("fs", async () => {
  const mockTemplates = {
    "test-template.html":
      "<html><body>Hello {{name}}! Your vehicle is {{vehicle}}.</body></html>",
    "test-template.txt": "Hello {{name}}! Your vehicle is {{vehicle}}.",
    "invalid-template.html":
      "<html><body>Hello {{name! Your vehicle is {{vehicle}}.</body></html>",
    "adf-response.html":
      "<html><body>Thank you for your interest in {{vehicleMake}} {{vehicleModel}}!</body></html>",
    "adf-response.txt":
      "Thank you for your interest in {{vehicleMake}} {{vehicleModel}}!",
  };
  ...
  describe("Template Rendering", () => {
    it("should load and render HTML template correctly", async () => {
      ...
      expect(renderedHtml).toBe(
        "<html><body>Hello John! Your vehicle is Honda Accord.</body></html>",
      );
    ...
    it("should load and render text template correctly", async () => {
      const renderedText = await emailService.renderTemplate(
        "test-template.txt",
        {
          name: "John",
          vehicle: "Honda Accord",
    ...
    it("should handle missing template files gracefully", async () => {
      ...
      await expect(
        emailService.renderTemplate("non-existent-template.html", {}),
    ...
    it("should handle invalid Handlebars syntax in templates", async () => {
      await expect(
        emailService.renderTemplate("invalid-template.html", {
          name: "John",
          vehicle: "Honda Accord",
        }),
    ...
    it("should cache templates for performance", async () => {
      ...
      await emailService.renderTemplate("test-template.html", {
        name: "John",
        vehicle: "Honda Accord",
      });
