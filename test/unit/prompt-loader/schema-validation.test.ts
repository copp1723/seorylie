...
const mockSchemaContent = {
  ...
  properties: {
    ...
    max_turn: {
      type: "integer",
      description:
        "Maximum conversation turn this prompt should be used for (if applicable)",
      minimum: 1,
      maximum: 10,
    },
    filepath: {
      type: "string",
      description:
        "Relative path to the prompt file from the prompts/adf directory",
...
const validMetadata = {
  ...
  description:
    "This is a valid description for the prompt template that meets the minimum length requirement.",
