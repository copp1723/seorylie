...
import { advancedRoutingEngine, type SentimentAnalysis, type CustomerContext, type RoutingDecision } from '../../server/services/agentSquad/advanced-routing';
...
describe('Agent Squad Routing System', () => {
  ...
  describe('Sentiment Analysis', () => {
    it('should correctly identify angry sentiment', async () => {
      const message = "I am absolutely furious with this terrible service! This is unacceptable!";
    ...
    it('should correctly identify excited sentiment', async () => {
      const message = "I'm so excited about this car! It's perfect and I can't wait to buy it!";
      const sentiment = await advancedRoutingEngine.analyzeSentiment(message);
    ...
    it('should correctly identify confused sentiment', async () => {
      const message = "I don't understand the difference between leasing and financing. Can you explain?";
      const sentiment = await advancedRoutingEngine.analyzeSentiment(message);
      
      expect(sentiment.emotion).toBe('confused');
      expect(sentiment.triggers).toContain(expect.stringContaining('understand'));
    });

    it('should detect urgency indicators', async () => {
      const message = "I need this car immediately! This is urgent and time sensitive!";
      const sentiment = await advancedRoutingEngine.analyzeSentiment(message);
  ...
  describe('Customer Context Analysis', () => {
    it('should retrieve customer context correctly', async () => {
      const context = await advancedRoutingEngine.getCustomerContext(1, 'test-user-123');
  ...
  describe('Routing Decision Logic', () => {
    ...
    it('should escalate customers with extensive escalation history', async () => {
      ...
      expect(decision.shouldEscalate).toBe(true);
      expect(decision.escalationReason).toContain('extensive escalation history');
    });
  ...
  describe('Agent Squad Orchestrator Integration', () => {
    ...
    it('should handle escalation scenarios', async () => {
      ...
      expect(result.response).toContain('connect you with one of our team members');
    });
  ...
  describe('Edge Cases and Error Handling', () => {
    ...
    it('should handle messages with special characters', async () => {
      const message = "I'm looking for a car with émojis 🚗 and speciāl characters!";
