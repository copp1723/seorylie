  ...
  return [
    {
      ...
      description:
        "Connection pool timeout occurs when load exceeds 500 RPS. Fixed by increasing max connections to 20.",
    },
    {
      id: "ISSUE-002",
      ...
      description:
        "Some error responses were missing trace IDs due to middleware ordering. Fixed by ensuring error handler runs last.",
    },
    {
      id: "ISSUE-003",
      ...
      description:
        "Cache invalidation was not triggering on ETL events. Fixed by adding Redis pub/sub channel.",
    },
    {
      id: "ISSUE-004",
      ...
      description:
        "Search performance slows down with >500 commands. Implementing indexed search with worker thread.",
    },
    {
      id: "ISSUE-005",
      ...
      description:
        "Some metrics are not displaying correctly on the integration dashboard. Need to fix data sources.",
    },
  ];
};
...
const generateMockConflictData = (): ConflictData[] => {
  return [
    ...
    },
    {
      ...
      conflictCount: 2,
      resolvedCount: 2,
      files: ["server/utils/error-handler.ts", "server/services/monitoring.ts"],
    },
    {
      ticketA: "INT-006",
      ticketB: "INT-008",
    ...
    },
    {
      ...
      resolvedCount: 2,
      files: [
        "client/src/utils/lazy-loading.tsx",
                    ...
                    <TableBody>
                      {teamMembers.map((member) => (
                        <TableRow key={member.id}>
                          ...
                          <TableCell align="right">
                            {member.ticketsCompleted}
                          </TableCell>
                          <TableCell align="right">
                            {member.conflictsResolved}
                          </TableCell>
                          <TableCell align="right">
                            {member.velocity.toFixed(2)}
                          </TableCell>
                        </TableRow>
                      ))}
                    </TableBody>
