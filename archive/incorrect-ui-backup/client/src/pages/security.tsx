...
export default function SecurityPage() {
  ...
  const handleGenerateNewKey = () => {
    ...
    if (
      confirm(
        "Are you sure you want to generate a new API key? This will invalidate the existing key.",
      )
    ) {
  ...
  const handleCopyKey = () => {
    navigator.clipboard.writeText(
      showApiKey
        ? apiKeyValue.replace("●●●●●●●●●●●●●●●●●●●●●●●●", "actualkey123")
        : apiKeyValue,
    );
    ...
    <div className="container mx-auto py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Manage security settings, API keys, and access controls for your
          account
        </p>
      </div>
                ...
                <div className="flex justify-between items-center pb-2 border-b border-gray-100">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      Current plan limit: 10,000 calls
                    </p>
                  </div>
              ...
              <Table>
                ...
                <TableBody>
                  ...
                  <TableRow>
                    ...
                    <TableCell className="text-sm">
                      Can manage users and view reports, but cannot change
                      system settings
                    </TableCell>
