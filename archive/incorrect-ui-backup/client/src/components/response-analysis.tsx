            ...
            <div className="bg-gray-50 p-4 rounded-md border">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-3">
                  <div>
                    <span className="font-semibold text-sm block text-gray-700">
                      Customer Name:
                    </span>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Badge
                      variant={
                        analysis.salesReadiness === "high"
                          ? "default"
                          : analysis.salesReadiness === "medium"
                            ? "secondary"
                            : "outline"
                      }
                      className="text-xs"
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Badge
                      variant={
                        analysis.handoverNeeded ? "destructive" : "outline"
                      }
                      className="text-xs"
                    >
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div>
                      <span className="font-semibold text-amber-900 text-sm block">
                        Escalation Reason:
                      </span>
        ...
        <div className="flex justify-center gap-2">
          ...
          {(analysis || handoverDossier) && (
            <Button
              ...
              size="sm"
              onClick={() =>
                handleCopy(JSON.stringify(handoverDossier || analysis, null, 2))
              }
            >
